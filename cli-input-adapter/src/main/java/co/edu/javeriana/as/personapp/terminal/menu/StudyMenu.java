...
public class StudyMenu {
    ...
    private static final int OPCION_VER_TODOS_ESTUDIOS = 1;
            ...
            try {
                ...
                switch (opcion) {
                    case OPCION_REGRESAR_MOTOR_PERSISTENCIA:
                        isValid = true;
                        break;
                    case OPCION_VER_TODOS_ESTUDIOS:
                        studyInputAdapterCli.viewStudies();
                        break;
                    default:
                        log.warn("La opción elegida no es válida.");
                }
                ...
                keyboard.next(); // Limpia el buffer de entrada
            }
        } while (!isValid);
    }
    ...
    private void mostrarMenuOpciones() {
        System.out.println("----------------------");
        System.out.println(OPCION_VER_TODOS_ESTUDIOS + " para ver todos los estudios");
